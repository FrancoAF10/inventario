...
<div class="container my-5">
  ...
  <div class="text-end mb-3">
    <button class="btn btn-success" onclick="window.location.href='./registrarCategoria.php'">
  ...
  <div class="card shadow">
    ...
    <div class="card-body table-responsive">
      <table class="table table-bordered table-hover align-middle" id="tabla-Categorias">
        <colgroup>
          <col style="width: 15%;">
          <col style="width: 65%;">
          <col style="width: 20%;">
          ...
          tabla.innerHTML += `
            <tr>
              ...
              <td class="text-center">
                <a href="editarCategoria.php?id=${element.idCategoria}" class="btn btn-outline-info btn-sm me-1" title="Editar">
                  <i class="fa-solid fa-pencil"></i>
                </a>
                <a href="#" class="btn btn-outline-danger btn-sm delete" data-idcategoria="${element.idCategoria}" title="Eliminar">
